...
public class WalletItemControllerTest {
    ...
    public void getWalletItemsTest() throws Exception {
        ...
        when(walletItemMapper.toDto(walletItemService.getWalletItems())).thenReturn(walletItemDtoList);
        //When & Then
    ...
    public void getWalletItemTest() throws Exception {
        ...
        when(walletItemMapper.toDto(walletItemService.findWalletItemById(4L))).thenReturn(walletItemDto1);
        //When & Then
    ...
    public void createWalletItemTest() throws Exception {
        ...
        when(walletItemMapper.toDto(walletItemService.postWalletItem
                (walletItemMapper.fromDto(walletItemDto1)))).thenReturn(walletItemDto1);
    ...
    public void updateWalletItemTest() throws Exception {
        ...
        when(walletItemMapper.toDto(walletItemService.updateWalletItem
                (walletItemMapper.fromDto(walletItemDto1)))).thenReturn(walletItemDto1);
